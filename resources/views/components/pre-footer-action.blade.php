...
<div {{ $attributes->class(['lg:grid grid-cols-2 gap-32'])}} >
    ...
    <div>
        <a href="{{ $url }}" class="bg-accent lg:bg-onAccent text-brand py-4 px-8 rounded-2xl block text-center text-base lg:text-xl">Обсудить проект</a>
    </div>
</div>