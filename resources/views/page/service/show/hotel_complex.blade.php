...
<main class="pt-28">
    <section class="pb-12" data-aos="fade-in" data-aos-easing="linear" data-aos-duration="1000">
        <div class="container">
            ...
            <p class="mb-10 lg:mb-16 lg:text-2xl">
                Создаем сайт удобный для людей, что бы было проще забронировать номер и спланировать отдых. Сайт
                подойдет, гостевым
                домам и отелям. Вот так выглядит главная страница многостраничного сайта:
            </p>
            <div class="h-[500px] xl:h-[765px] overflow-auto">
                <img class="block w-full" src="/template/images/service/2023/03/01/sudak-otel.png" alt="">
            </div>
        </div>
    </section>
    ...
    <section class="pb-10 aos-init aos-animate" data-aos="fade-in" data-aos-easing="linear" data-aos-duration="1000">
        <div class="container">
            ...
            <p class="p-0">
                Каждый человек выбирает место отдыха согласно своего визуального вкуса, поэтому важно сделать
                качественные фотографии.
                Хорошие провессиональные фотографии привлекают больше внимания, так как соблюдаются условия постановки
                композиции, а
                правильно выстроенный кадр дольше удерживает внимание.
            </p>
    ...
    <section class="pt-8 pb-[90px] aos-init aos-animate" data-aos="fade-in" data-aos-easing="linear"
        ...
        <div class="container">
            ...
            <p class="pb-5">
                Фотосъемку номеров делает интеръерный фотограф, можно попробовать найти таких в просторах интернета или
                заказать у нас.
            </p>
            <p class="pb-10">
                Фотосъемка интерьера с созданием панорам номеров входит в комплексное решение по созданию сайта.
                Примеры интерьерных фотографий
            </p>
    ...
    <section class="pb-[90px] aos-init aos-animate" data-aos="fade-in" data-aos-easing="linear"
        ...
        <div class="container">
            ...
            <p class="p-0">
                Местоположение легко отобразить в карте на сайте гостиницы, но лучше разместить информацию о своем
                объекте еще и на
                Яндекс.Картах, 2ГИС. Это поможет людям найти вас, когда они ищут по определенной удаленности от моря,
                парка и прочего.
                Помимо метки на карте можно добавить виды из окна или территории.
            </p>
        </div>
    </section>
    <section class="pb-[90px] aos-init aos-animate" data-aos="fade-in" data-aos-easing="linear"
        ...
        <div class="container">
            ...
            <p class="p-0">
                По данным исследования ВЦИОМ от 50 до 80% пользователей интернета доверяют отзывам. Поэтому важно
                работать с отзывами и
                следить за репутацией организации и рейтингом на отзовиках.
            </p>
            <p class="p-0">
            ...
            <ul class="list-point">
                <li>
                    Когда потенциальные гости видят, что похожие на них люди с радостью совершают бронирование и
                    довольны визитом, то это
                    увеличивает количество броней:
                </li>
                <li>
    ...
    <section class="pb-[90px] aos-init aos-animate" data-aos="fade-in" data-aos-easing="linear"
        ...
        <div class="container">
            ...
            <p>
                ...
                отдых именном к
                вам. <br>Описания условий проживания подкрепленные фотографими или видео обзором номеров, территории
                сформируют больше
                доверия и помогут понять, что из вещей можно не брать с собой в поездку.
            </p>
        </div>
    </section>
