...
class ServiceCategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $categories = [
            ...
            [
                'title' => 'CRM системы и сервисы',
                'description' => '<p>CRM системы и сервисы позволяют современным предприятиям настроить бизнес процессы, вести клиентсую базу, формировать отчеты и смотреть статистику - достигать максимальную эффективность от деятельности.</p>',
                'icon' => '<lord-icon src="/template/lord-icon/crm.json" trigger="loop" delay="1500" colors="primary:#F0F0F0,secondary:#cbe857" stroke="35" style="width:100px;height:100px"></lord-icon>',
                'content' =>  '<p>CRM система – необходимый инструмент для современного и эффективного управления бизнес-процессами на предприятии. Она позволяет собирать, анализировать и использовать данные о клиентах для повышения продаж, улучшения обслуживания, оптимизации бизнес-процессов. С помощью CRM системы можно формировать необходимые отчеты, отслеживать эффективность работы сотрудников. CRM помогает сократить время на поиск информации, повысить лояльность клиентов и как следствие увеличить прибыльность компании.</p>',
            ],
            [
                'title' => 'Фотосъемка',
            ...
            [
                ...
                'description' => '<p>CRM системы и сервисы позволяют современным предприятиям настроить бизнес процессы, вести клиентсую базу, формировать отчеты и смотреть статистику - достигать максимальную эффективность от деятельности.</p>',
                'icon' => '<lord-icon src="/template/lord-icon/complex.json" trigger="loop" delay="1500" colors="primary:#F0F0F0,secondary:#cbe857" stroke="35" style="width:100px;height:100px"></lord-icon>',
                'content' =>  '<p>CRM система – необходимый инструмент для современного и эффективного управления бизнес-процессами на предприятии. Она позволяет собирать, анализировать и использовать данные о клиентах для повышения продаж, улучшения обслуживания, оптимизации бизнес-процессов. С помощью CRM системы можно формировать необходимые отчеты, отслеживать эффективность работы сотрудников. CRM помогает сократить время на поиск информации, повысить лояльность клиентов и как следствие увеличить прибыльность компании.</p>',
            ],
        ];
